...
def handle_number():
    ...
    # Store the number value in a variable
    my_number = int(number)
    return my_number
investment=handle_number()
'''
class CustomEnv:
    ...
    def save(self, name="Crypto_trader"):
        ...
        self.Actor.Actor.save_weights("/home/nizar/Projet-de-Conception-et-de-Developpement-Trading-Platform/Model_AI/RL-Bitcoin-trading-bot_3/Crypto_trader_Actor.h5")
        self.Critic.Critic.save_weights("/home/nizar/Projet-de-Conception-et-de-Developpement-Trading-Platform/Model_AI/RL-Bitcoin-trading-bot_3/Crypto_trader_Critic.h5")

    def load(self, name="Crypto_trader"):
        # load keras model weights
        self.Actor.Actor.load_weights("/home/nizar/Projet-de-Conception-et-de-Developpement-Trading-Platform/Model_AI/RL-Bitcoin-trading-bot_3/Crypto_trader_Actor.h5")
        self.Critic.Critic.load_weights("/home/nizar/Projet-de-Conception-et-de-Developpement-Trading-Platform/Model_AI/RL-Bitcoin-trading-bot_3/Crypto_trader_Critic.h5")
...
def get_result():
  df = pd.read_csv('/home/nizar/Projet-de-Conception-et-de-Developpement-Trading-Platform/Model_AI/RL-Bitcoin-trading-bot_3/pricedata.csv')
...
#train_agent(train_env, visualize=False, train_episodes=20000, training_batch_size=500)
  result=test_agent(test_env, visualize=True, test_episodes=1000)
